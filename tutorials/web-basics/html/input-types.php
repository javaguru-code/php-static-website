        ...
        <div class="row">
                ...
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active" href="input-types">Input Types</a>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    ...
                    <div class="lead mb-4">
                        Different types of form input elements in HTML5.
                    </div>
...
<!-- Telephone input -->
<input type="tel" placeholder="Enter phone number"></code></pre>
                    ...
                    <p>Input types for dates and times:</p>
                    <pre><code class="language-html">
<!-- Date input -->
<input type="date">
...
<input type="week"></code></pre>
        ...
        <section>
                        ...
                        <p>
                            This is the overview section for HTML Input Types.
                        </p>
                    </section>
...
<li>Best practice 3</li>
                ...
                <div class="d-flex justify-content-between mt-5">
                    <a href="forms" class="btn btn-outline-primary">

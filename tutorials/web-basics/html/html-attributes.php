<?php require __DIR__ . '/_template.php'; ?>
...
// Include header using the base directory
        ...
        <div class="row">
                ...
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active" href="html-attributes">HTML Attributes</a>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    ...
                    <div class="lead mb-4">
                        Learn about HTML attributes and how they modify elements.
                    </div>
                    ...
                    <p>HTML attributes provide additional information or modify the behavior of HTML elements.</p>
...
<input type="text" required></code></pre>
                    ...
                    <ul>
                        <li><code>class</code>: For CSS styling and JavaScript selection</li>
                        <li><code>id</code>: Unique identifier for an element</li>
                        <li><code>style</code>: Inline CSS styles</li>
                        <li><code>title</code>: Additional information shown on hover</li>
                    </ul>
        ...
        <section>
                        ...
                        <p>
                            This is the overview section for HTML Attributes.
                        </p>
                    </section>
...
<li>Best practice 3</li>
                ...
                <div class="d-flex justify-content-between mt-5">
                    <a href="html-elements" class="btn btn-outline-primary">
                        <i class="bi bi-arrow-left"></i> Previous
                    </a>
                    <a href="html-comments" class="btn btn-outline-primary">

...
﻿<?php
$page_title = 'Sitemaps - Full Stack Master';
        ...
        <div class="row">
                ...
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active" href="sitemap">Sitemaps</a>
                        </nav>
                    </div>
                </div>
            </aside>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    <h1>Sitemaps</h1>
                    <div class="lead mb-4">
                        Create and optimize XML sitemaps for SEO.
                    </div>

                    <section>
                        <h2>Overview</h2>
                        <p>
                            This is the overview section for Sitemaps.
                        </p>
                    </section>

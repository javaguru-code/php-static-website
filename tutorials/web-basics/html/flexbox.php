<?php
$page_title = 'Flexbox - Full Stack Master';
        ...
        <div class="row">
                ...
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active" href="flexbox">Flexbox</a>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    <h1>Flexbox</h1>
                    <div class="lead mb-4">
                        Layout elements using CSS Flexbox.
                    </div>

                    <section>
                        <h2>Overview</h2>
                        <p>
                            This is the overview section for Flexbox.
                        </p>
                    </section>

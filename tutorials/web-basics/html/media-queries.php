<?php
$page_title = 'Media Queries - Full Stack Master';
            ...
            <aside class="col-lg-3 d-none d-lg-block sidebar-nav p-0">
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <!-- Responsive Design -->
                        <nav class="nav flex-column">
                            <a class="nav-link active" href="media-queries"><i class="bi bi-phone"></i> Media Queries</a>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    ...
                    <section>
                        <h2>Overview</h2>
                        <p>
                            This is the overview section for Media Queries.
                        </p>
                    </section>

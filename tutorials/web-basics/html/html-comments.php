        ...
        <div class="row">
                ...
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active" href="html-comments">HTML Comments</a>
                        </nav>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    <h1>HTML Comments</h1>
                    <div class="lead mb-4">
                        Adding comments to your HTML code for better documentation.
                    </div>

                    <section>
                        <h2>Overview</h2>
                        <p>
                            This is the overview section for HTML Comments.
                        </p>
                    </section>

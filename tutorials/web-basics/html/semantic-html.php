<?php
$page_title = 'Semantic HTML - Full Stack Master';
        ...
        <div class="row">
                ...
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active" href="semantic-html">Semantic HTML</a>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    <h1>Semantic HTML</h1>
                    <div class="lead mb-4">
                        Write meaningful HTML for better accessibility.
                    </div>

                    <section>
                        <h2>Overview</h2>
                        <p>
                            This is the overview section for Semantic HTML.
                        </p>
                    </section>
...
<li>Best practice 3</li>
                ...
                <div class="d-flex justify-content-between mt-5">
                    <a href="aria" class="btn btn-outline-primary">

        ...
        <div class="row">
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    <h1>HTML Images</h1>
                    <div class="lead mb-4">
                        Add and optimize images in your web pages.
                    </div>
                    ...
                    <p>The basic syntax for adding images:</p>
                    <pre><code class="language-html">
<img src="path/to/image.jpg" alt="Description of image">
<img src="logo.png" alt="Company Logo" width="200" height="100"></code></pre>
                    
                    <div class="alert alert-info">
                        <h4>Important Attributes:</h4>
                        <ul>
                            <li><code>src</code>: Source path to the image</li>
                    ...
                    <p>Make images responsive using the srcset attribute:</p>
                    <pre><code class="language-html">
<img srcset="small.jpg 300w,
     ...
     alt="Responsive image"></code></pre>
        ...
        <section>
                        ...
                        <p>
                            This is the overview section for HTML Images.
                        </p>
                    </section>
...
<li>Best practice 3</li>
                ...
                <div class="d-flex justify-content-between mt-5">
                    ...
                    <a href="links" class="btn btn-outline-primary">

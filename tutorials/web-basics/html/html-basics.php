<?php
$page_title = 'HTML Basics & Structure - Full Stack Master';
        ...
        <div class="row">
            ...
            <aside class="col-lg-3 d-none d-lg-block sidebar-nav p-0">
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <!-- HTML Fundamentals -->
                        <nav class="nav flex-column">
                            <a class="nav-link active" href="html-basics"><i class="bi bi-code"></i> HTML Basics & Structure</a>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    ...
                    <div class="lead mb-4">
                        Understanding HTML document structure, elements, and basic concepts.
                    </div>
...
<body>
    <!-- Content goes here -->
                    ...
                    <ul>
                        ...
                        <li><code>head</code>: Contains metadata and document information</li>
                    ...
                    <ul>
                        <li>Opening tag: <code>&lt;tagname&gt;</code></li>
                        <li>Content: Text or other elements</li>
                        <li>Closing tag: <code>&lt;/tagname&gt;</code></li>
                    </ul>
                    <p>Example:</p>
                    <pre><code class="language-html">
<p>This is a paragraph.</p>
<h1>This is a heading.</h1>
<div>This is a division.</div></code></pre>
                
                    </section>
        <section>
                        <h2>Best Practices</h2>
                        <p>
                            This is the overview section for HTML Basics & Structure.
                        </p>
                    </section>

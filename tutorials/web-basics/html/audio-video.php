<?php
$page_title = 'HTML Audio & Video - Full Stack Master';
        ...
        <div class="row">
            ...
            <aside class="col-lg-3 d-none d-lg-block sidebar-nav p-0">
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <!-- Media & Graphics -->
                        <nav class="nav flex-column">
                            <a class="nav-link active" href="audio-video"><i class="bi bi-play-circle"></i> Audio & Video</a>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    ...
                    <p>Adding video content to your page:</p>
...
<audio controls autoplay loop>
    <source src="background.mp3" type="audio/mpeg">
        ...
        <section>
                        ...
                        <p>
                            This is the overview section for HTML Audio & Video.
                        </p>
                    </section>
...
<li>Best practice 3</li>
                ...
                <div class="d-flex justify-content-between mt-5">
                    <a href="form-validation" class="btn btn-outline-primary">
                        <i class="bi bi-arrow-left"></i> Previous
                    </a>
                    <a href="canvas-svg" class="btn btn-outline-primary">

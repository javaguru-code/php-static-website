        ...
        <div class="row">
                ...
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active" href="html-elements">HTML Elements</a>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    <h1>HTML Elements</h1>
                    <div class="lead mb-4">
                        Deep dive into HTML elements and their usage in web development.
                    </div>
                    ...
                    <p>Block-level elements start on a new line and take up the full width:</p>
                    <pre><code class="language-html">
<div>A division</div>
<p>A paragraph</p>
<h1>A heading</h1>
<section>A section</section></code></pre>
                    ...
                    <p>Inline elements don't start on a new line:</p>
                    <pre><code class="language-html">
<span>A span</span>
<a href="#">A link</a>
...
<em>Emphasized text</em></code></pre>
        ...
        <section>
                        ...
                        <p>
                            This is the overview section for HTML Elements.
                        </p>
                    </section>
...
<li>Best practice 3</li>
                ...
                <div class="d-flex justify-content-between mt-5">
                    <a href="html-basics" class="btn btn-outline-primary">
                        <i class="bi bi-arrow-left"></i> Previous
                    </a>
                    <a href="html-attributes" class="btn btn-outline-primary">

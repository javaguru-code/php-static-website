<?php
$page_title = 'HTML5 Semantic Elements - Full Stack Master';
        ...
        <div class="row">
            ...
            <aside class="col-lg-3 d-none d-lg-block sidebar-nav p-0">
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <!-- HTML5 Features -->
                        <nav class="nav flex-column">
                            <a class="nav-link active" href="semantic-elements"><i class="bi bi-code-square"></i> Semantic Elements</a>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    ...
                    <p>Semantic elements for page structure:</p>
...
<footer>
    <p>&copy; 2025 Your Site</p>
                    ...
                    <p>Semantic elements for content:</p>
                    <pre><code class="language-html">
<article>
    <header>
        <h1>Article Title</h1>
    ...
    <mark>Highlighted text</mark>
        ...
        <section>
                        ...
                        <p>
                            This is the overview section for HTML5 Semantic Elements.
                        </p>
                    </section>

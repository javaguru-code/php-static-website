        ...
        <div class="row">
            ...
            <aside class="col-lg-3 d-none d-lg-block sidebar-nav p-0">
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <!-- Forms & Input -->
                        <nav class="nav flex-column">
                            <a class="nav-link active" href="forms"><i class="bi bi-ui-checks"></i> HTML Forms</a>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    <h1>HTML Forms</h1>
                    <div class="lead mb-4">
                        Create interactive forms for user input and data collection.
                    </div>
                    ...
                    <p>HTML forms are used to collect user input and send it to a server for processing.</p>
...
<form action="/submit" method="post">
    ...
    <button type="submit">Submit</button>
                    ...
                    <p>Key form attributes:</p>
                    <ul>
                        <li><code>action</code>: Where to send the form data</li>
                        <li><code>method</code>: HTTP method to use (GET or POST)</li>
                        <li><code>enctype</code>: How to encode the data</li>
                    </ul>
                    ...
                    <p>Common form controls include:</p>
                    <div class="row g-4">
                        <div class="col-md-6">
                            <h5>Text Input</h5>
                            <pre><code class="language-html">
...
<select>
    <option>Option 1</option>
        ...
        <section>
                        ...
                        <p>
                            This is the overview section for HTML Forms.
                        </p>
                    </section>
...
<li>Best practice 3</li>
                ...
                <div class="d-flex justify-content-between mt-5">
                    <a href="tables" class="btn btn-outline-primary">
                        <i class="bi bi-arrow-left"></i> Previous
                    </a>
                    <a href="input-types" class="btn btn-outline-primary">

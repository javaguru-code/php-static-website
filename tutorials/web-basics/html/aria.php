<?php
$page_title = 'ARIA - Full Stack Master';
        ...
        <div class="row">
            ...
            <aside class="col-lg-3 d-none d-lg-block sidebar-nav p-0">
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <!-- Accessibility -->
                        <nav class="nav flex-column">
                            <a class="nav-link active" href="aria"><i class="bi bi-universal-access"></i> ARIA</a>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    <h1>ARIA</h1>
                    <div class="lead mb-4">
                        Make web content accessible with ARIA attributes.
                    </div>

                    <section>
                        <h2>Overview</h2>
                        <p>
                            This is the overview section for ARIA.
                        </p>
                    </section>
...
<li>Best practice 3</li>
                ...
                <div class="d-flex justify-content-between mt-5">
                    <a href="responsive-typography" class="btn btn-outline-primary">
                        <i class="bi bi-arrow-left"></i> Previous
                    </a>
                    <a href="semantic-html" class="btn btn-outline-primary">

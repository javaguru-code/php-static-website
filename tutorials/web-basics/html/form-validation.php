<?php
$page_title = 'Form Validation - Full Stack Master';
        ...
        <div class="row">
                ...
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active" href="form-validation">Form Validation</a>
                        </nav>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    ...
                    <div class="lead mb-4">
                        Validate form input using HTML5 attributes and JavaScript.
                    </div>
                    ...
                    <p>HTML5 provides several validation attributes:</p>
...
<input type="text" required 
       ...
       oninput="this.setCustomValidity('')"></code></pre>
                    ...
                    <p>CSS pseudo-classes for form validation:</p>
...
input:required {
    border-width: 2px;
        ...
        <section>
                        ...
                        <p>
                            This is the overview section for Form Validation.
                        </p>
                    </section>
...
<li>Best practice 3</li>
                ...
                <div class="d-flex justify-content-between mt-5">
                    <a href="form-elements" class="btn btn-outline-primary">

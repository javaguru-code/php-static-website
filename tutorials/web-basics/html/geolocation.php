<?php
$page_title = 'Geolocation - Full Stack Master';
        ...
        <div class="row">
                ...
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active" href="geolocation">Geolocation</a>
                        </nav>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    <h1>Geolocation</h1>
                    <div class="lead mb-4">
                        Access user location using HTML5 Geolocation API.
                    </div>

                    <section>
                        <h2>Overview</h2>
                        <p>
                            This is the overview section for Geolocation.
                        </p>
                    </section>
...
<li>Best practice 3</li>
                ...
                <div class="d-flex justify-content-between mt-5">
                    <a href="local-storage" class="btn btn-outline-primary">
                        <i class="bi bi-arrow-left"></i> Previous
                    </a>
                    <a href="media-queries" class="btn btn-outline-primary">

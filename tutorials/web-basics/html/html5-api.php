<?php
$page_title = 'HTML5 APIs - Full Stack Master';
        ...
        <div class="row">
                ...
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active" href="html5-api">HTML5 APIs</a>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    <h1>HTML5 APIs</h1>
                    <div class="lead mb-4">
                        Explore HTML5's powerful JavaScript APIs.
                    </div>

                    <section>
                        <h2>Overview</h2>
                        <p>
                            This is the overview section for HTML5 APIs.
                        </p>
                    </section>
...
<li>Best practice 3</li>
                ...
                <div class="d-flex justify-content-between mt-5">
                    <a href="semantic-elements" class="btn btn-outline-primary">

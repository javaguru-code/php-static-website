<?php
$page_title = 'HTML Headings & Paragraphs - Full Stack Master';
        ...
        <div class="row">
            ...
            <aside class="col-lg-3 d-none d-lg-block sidebar-nav p-0">
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <!-- Text & Content -->
                        <nav class="nav flex-column">
                            <a class="nav-link active" href="headings-paragraphs"><i class="bi bi-text-left"></i> Headings & Paragraphs</a>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    ...
                    <div class="lead mb-4">
                        Learn how to structure content using HTML headings and paragraphs.
                    </div>

                    <section>
                        <h2>Overview</h2>
                        <p>
                            This is the overview section for HTML Headings & Paragraphs.
                        </p>
                    </section>

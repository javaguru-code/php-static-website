<?php
$page_title = 'Responsive Images - Full Stack Master';
                ...
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active" href="responsive-images">Responsive Images</a>
                        </nav>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    ...
                    <section>
                        <h2>Overview</h2>
                        <p>
                            This is the overview section for Responsive Images.
                        </p>
                    </section>

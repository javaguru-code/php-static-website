<?php
$page_title = 'Text Formatting - Full Stack Master';
        ...
        <div class="row">
                ...
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active" href="text-formatting">Text Formatting</a>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    ...
                    <div class="lead mb-4">
                        Format text using HTML elements for emphasis and style.
                    </div>
                    ...
                    <p>HTML provides several elements for basic text formatting:</p>
...
<u>Underlined text</u>
<s>Strikethrough text</s></code></pre>
                    ...
                    <p>Elements for organizing text content:</p>
                    <pre><code class="language-html">
...
<pre>Preformatted text
    maintains spacing
    and line breaks</pre>
<code>Computer code</code></code></pre>
                
                    </section>
        <section>
                        <h2>Best Practices</h2>
                        <p>
                            This is the overview section for Text Formatting.
                        </p>
                    </section>
...
<li>Best practice 3</li>
                ...
                <div class="d-flex justify-content-between mt-5">
                    <a href="headings-paragraphs" class="btn btn-outline-primary">
                        <i class="bi bi-arrow-left"></i> Previous
                    </a>
                    <a href="lists" class="btn btn-outline-primary">

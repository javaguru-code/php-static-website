<?php
$page_title = 'CSS Grid - Full Stack Master';
                ...
                <div class="sticky-top pt-3 sticky-sidebar">
                    <div class="sidebar-content px-3">
                        ...
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active" href="grid">CSS Grid</a>
            ...
            <main class="col-lg-9 pt-3 px-lg-4">
                ...
                <article class="tutorial-content">
                    ...
                    <section>
                        <h2>Overview</h2>
                        <p>
                            This is the overview section for CSS Grid.
                        </p>
                    </section>
...
<li>Best practice 3</li>
                ...
                <div class="d-flex justify-content-between mt-5">
                    <a href="flexbox" class="btn btn-outline-primary">

...
The reversed array is: 
1 0 9 3 8 4
</pre></div><p><strong>Complexity Analysis:</strong> The time complexity of the program is the same as the previous program. There is no extra space used in the program, making the space complexity of the program O(1).</p><h2 class="h2">Approach 3: Using Stack</h2><p>Since a Stack works on the LIFO (Last In First Out) principle, it can be used to reverse the input array. All we have to do is to put all the elements of the input array in the stack, starting from left to right. We will do it using a loop.</p><p><strong>FileName:</strong> ReverseArr2.java</p><div class="codeblock"><textarea class="java" name="code">// importing Stack
...
The reversed array is: 
1 0 9 3 8 4
</pre></div><p><strong>Complexity Analysis:</strong> The time complexity of the program is the same as the previous program. There is stack used in the program, making the space complexity of the program O(n).</p><h3 class="h3">Using Recursion</h3><p>Using recursion also, we can achieve the same result. Observe the following.</p><p><strong>FileName:</strong> ReverseArr3.java</p><div class="codeblock"><textarea class="java" name="code">// importing ArrayList
...
The reversed array is: 
1 0 9 3 8 4
</pre></div><p><strong>Complexity Analysis:</strong> The program uses <em>Collections.reverse()</em> method that reverses the list in linear time, making the time complexity of the program O(n). The program uses using list, making the space complexity of the program O(n), where n is the total number of elements present in the array.</p><h4 class="n">Note 1: <em>Collections.reverse()</em> method is also used to reverse the linked list.</h4><h4 class="n">Note 2: All the approaches discussed above are applicable to different data types too.</h4><h2 class="h2">Approach 5: Using StringBuilder.append() method</h2><p>It is evident from the heading that this approach is applicable to string arrays. Using the StringBuilder.append() method, we can reverse the string array. All we have to do is to start appending the string elements of the array from the last to the beginning.</p><p><strong>FileName:</strong> ReverseArr5.java</p><div class="codeblock"><textarea class="java" name="code">import java.util.*;

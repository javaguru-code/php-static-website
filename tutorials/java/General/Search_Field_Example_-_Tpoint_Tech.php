...
&lt;project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  &lt;/build&gt;
&lt;/project&gt;
</textarea></div><ul class="points"><li>Create the configuration classes<br/>Instead of XML, we perform annotation-based configuration. So, we create two classes and specify the required configuration in it.</li></ul><p><strong>DemoAppConfig.java</strong></p><div class="codeblock"><textarea class="java" name="code">
...
</textarea></div><p><strong>MySpringMvcDispatcherServletInitializer.java</strong></p><div class="codeblock"><textarea class="java" name="code">
package com.javatpoint.searchfieldexample.config;
...
</textarea></div><ul class="points"><li>Create the entity class<br/>Here, we are creating an Entity/POJO (Plain Old Java Object) class.</li></ul><p><strong>User.java</strong></p><div class="codeblock"><textarea class="java" name="code">
...
</textarea></div><ul class="points"><li>Create the DAO interface<br/>Here, we are creating the DAO interface to perform database related operations.</li></ul><p><strong>UserDAO.java</strong></p><div class="codeblock"><textarea class="java" name="code">
...
&lt;/user&gt;</textarea></div><ul class="points"><li>Create the DAO interface implementation class</li></ul><p><strong>UserDAOImpl.java</strong></p><div class="codeblock"><textarea class="java" name="code">
...
</textarea></div><ul class="points"><li>Create the service layer interface<br/>Here, we are creating a service layer interface that acts as a bridge between DAO and Entity classes.</li></ul><p><strong>UserService.java</strong></p><div class="codeblock"><textarea class="java" name="code">
...
&lt;/user&gt;</textarea></div><ul class="points"><li>Create the service layer implementation class</li></ul><p><strong>UserServiceImpl.java</strong></p><div class="codeblock"><textarea class="java" name="code">
...
&lt;/user&gt;</textarea></div><ul class="points"><li>Create the controller class</li></ul><p><strong>UserController.java</strong></p><div class="codeblock"><textarea class="java" name="code">
...
&lt;/user&gt;</textarea></div><ul class="points"><li>Creating the properties file<br/>Here, we are creating the properties file inside the <strong>src/main/resources</strong> in the project.</li></ul><p><strong>persistence-mysql.properties</strong></p><div class="codeblock"><textarea class="java" name="code">
#
...
</textarea></div><h2 class="h2">Angular Module</h2><p>Let's see the directory structure of Angular we need to follow:</p><img alt="Spring Angular Search Field Application" src="https://d2jdgazzki9vjm.cloudfront.net/sppages/angular/images/spring-angular-search-field-application2.png"><ul class="points"><li>Create an Angular project</li></ul><p>Let's create an Angular project by using the following command:</p><p><em>ng new SearchFieldExample</em></p><img alt="Spring Angular Search Field Application" src="https://d2jdgazzki9vjm.cloudfront.net/sppages/angular/images/spring-angular-search-field-application3.png"><br/><img alt="Spring Angular Search Field Application" src="https://d2jdgazzki9vjm.cloudfront.net/sppages/angular/images/spring-angular-search-field-application4.png"><p>Here, <strong>SearchFieldExample</strong> is the name of the project.</p><h2 class="h2">Install Bootstrap CSS framework</h2><p>Use the following command to install bootstrap in the project.</p><p><em>npm install <a class="__cf_email__" data-cfemail="a7c5c8c8d3d4d3d5c6d7e79489948990" href="/cdn-cgi/l/email-protection">[email protected]</a> --save</em></p><p>Now, include the following code in the style.css file.</p><div class="codeblock"><textarea class="java" name="code">
@import "~bootstrap/dist/css/bootstrap.css";
</textarea></div><ul class="points"><li>Generate Component<br/>Open the project in visual studio and then use the following command to generate Angular component:<br/><em>ng g c ShowData</em></li></ul><img alt="Spring Angular Search Field Application" src="https://d2jdgazzki9vjm.cloudfront.net/sppages/angular/images/spring-angular-search-field-application5.png"><p>Let's also create a service class by using the following command: -</p><p><em>ng g s services/User</em></p><img alt="Spring Angular Search Field Application" src="https://d2jdgazzki9vjm.cloudfront.net/sppages/angular/images/spring-angular-search-field-application6.png"><ul class="points"><li>Edit the app.module.ts file<ul class="points"><li><strong>Import HttpModule</strong> - Here, we are importing <strong>HttpModule</strong> for server requests and specifying it in imports array.</li><li><strong>Register Service class</strong> - Here, we are mentioning the service class in providers array.</li><li><strong>Import ReactiveFormsModule</strong> - Here, we are importing <strong>ReactiveFormsModule</strong> for reactive forms and specifying it in imports array.</li></ul></li></ul><div class="codeblock"><textarea class="java" name="code">
...
</textarea></div><ul class="points"><li>Edit the <strong>app.component.html</strong> file</li></ul><div class="codeblock"><textarea class="java" name="code">
&lt;app-show-data&gt;&lt;/app-show-data&gt;
</textarea></div><ul class="points"><li>Create the <strong>User.ts</strong> class</li></ul><p>Let's create a class by using the following command: -</p><p><em>ng g class classes/User</em></p><img alt="Spring Angular Search Field Application" src="https://d2jdgazzki9vjm.cloudfront.net/sppages/angular/images/spring-angular-search-field-application7.png"><p>Now, specify the required fields within the <strong>User</strong> class.</p><div class="codeblock"><textarea class="java" name="code">
export class User {
...
</textarea></div><p>The purpose of this class is to map the specified fields with the fields of the Spring entity class.</p><ul class="points"><li>Edit the <strong>user.service.ts</strong> file</li></ul><div class="codeblock"><textarea class="java" name="code">
...
</textarea></div><ul class="points"><li>Edit the <strong>show-data.component.ts</strong> file</li></ul><div class="codeblock"><textarea class="java" name="code">
...
</textarea></div><ul class="points"><li>Edit the <strong>show-data.component.html</strong> file</li></ul><div class="codeblock"><textarea class="java" name="code">
&lt;br&gt;&lt;br&gt;

<?php
// Tutorial: Online C Compiler (Editor) - Tpoint Tech
?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>Online C Compiler (Editor) - Tpoint Tech</title>
    <link rel="stylesheet" href="../style.css">
</head>
<body>
    <div class="tutorial-container">
        <h1>Online C Compiler (Editor) - Tpoint Tech</h1>
        <body>
<script>
...
<div class="tagline">
<h1>Online C Compiler (Editor)</h1></div>
</div>
</div>
<div class="container">

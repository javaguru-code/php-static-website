<?php
// Tutorial: Online Python Compiler (Interpreter) - Tpoint Tech
?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>Online Python Compiler (Interpreter) - Tpoint Tech</title>
    <link rel="stylesheet" href="../style.css">
</head>
<body>
    <div class="tutorial-container">
        <h1>Online Python Compiler (Interpreter) - Tpoint Tech</h1>
        <body>
<script>
...
<div class="tagline">
<h1>Online Python Compiler (Interpreter)</h1></div>
</div>
</div>
<div class="container">
